...
return cljs.core._write.call(null,writer__5204__auto__,"reagent.impl.template/NativeWrapper");
});
...
var or__4605__auto__ = reagent.impl.template.named_QMARK_.call(null,x);
...
var or__4605__auto__ = reagent.impl.template.hiccup_tag_QMARK_.call(null,x);
if(cljs.core.truth_(or__4605__auto__)){
return or__4605__auto__;
} else {
...
var G__6279 = o;
(G__6279[reagent.impl.template.cached_prop_name.call(null,k)] = reagent$impl$template$convert_prop_value.call(null,v));
...
while (G__6281__i < G__6281__a.length) {G__6281__a[G__6281__i] = arguments[G__6281__i + 0]; ++G__6281__i;}
  args = new cljs.core.IndexedSeq(G__6281__a,0);
} 
...
var old_6283 = (p["className"]);
(p["className"] = ((cljs.core.some_QMARK_.call(null,old_6283))?[cljs.core.str(class$),cljs.core.str(" "),cljs.core.str(old_6283)].join(''):class$));
} else {
}
...
if(cljs.core.not.call(null,(function (){var and__4593__auto__ = (node === document.activeElement);
if(and__4593__auto__){
var and__4593__auto____$1 = reagent.impl.template.has_selection_api_QMARK_.call(null,(node["type"]));
...
var G__6286 = jsprops;
(G__6286["defaultValue"] = value);

(G__6286["onChange"] = ((function (G__6286,v,value,on_change){
return (function (p1__6284_SHARP_){
return reagent.impl.template.input_handle_change.call(null,this$,on_change,p1__6284_SHARP_);
});})(G__6286,v,value,on_change))
);
...
var vec__6288 = cljs.core.next.call(null,cljs.core.re_matches.call(null,reagent.impl.template.re_tag,cljs.core.name.call(null,hiccup_tag)));
var tag = cljs.core.nth.call(null,vec__6288,(0),null);
var id = cljs.core.nth.call(null,vec__6288,(1),null);
var class$ = cljs.core.nth.call(null,vec__6288,(2),null);
...
var temp__4659__auto__ = (function (){var G__6292 = cljs.core.meta.call(null,v);
if((G__6292 == null)){
return null;
} else {
return reagent.impl.template.get_key.call(null,G__6292);
}
})();
if((temp__4659__auto__ == null)){
...
var jsprops = {"argv": v};
var G__6294_6295 = v;
var G__6294_6296__$1 = (((G__6294_6295 == null))?null:reagent.impl.template.key_from_vec.call(null,G__6294_6295));
if((G__6294_6296__$1 == null)){
} else {
(jsprops["key"] = G__6294_6296__$1);
}
...
var p = (function (){var temp__4659__auto__ = (function (){var G__6299 = cljs.core.meta.call(null,argv);
if((G__6299 == null)){
return null;
} else {
return reagent.impl.template.get_key.call(null,G__6299);
}
})();
if((temp__4659__auto__ == null)){
return jsprops;
...
var G__6300 = (((jsprops == null))?{}:jsprops);
(G__6300["key"] = key);
...
var G__6301 = new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subs.call(null,n,(0),pos),cljs.core.assoc.call(null,v,(0),cljs.core.subs.call(null,n,(pos + (1))))], null);
v = G__6301;
continue;
}
} else {
...
var n__5508__auto___6302 = a.length;
var i_6303 = (0);
while(true){
if((i_6303 < n__5508__auto___6302)){
(a[i_6303] = reagent.impl.template.as_element.call(null,(a[i_6303])));
...
var a = cljs.core.into_array.call(null,s);
var n__5508__auto___6305 = a.length;
var i_6306 = (0);
while(true){
if((i_6306 < n__5508__auto___6305)){
var val_6307 = (a[i_6306]);
if((cljs.core.vector_QMARK_.call(null,val_6307)) && ((reagent.impl.template.key_from_vec.call(null,val_6307) == null))){
(o["no-key"] = true);
} else {
}

(a[i_6306] = reagent.impl.template.as_element.call(null,val_6307));
...
if(cljs.core.truth_((function (){var and__4593__auto__ = cljs.core.not.call(null,reagent.impl.component._STAR_non_reactive_STAR_);
if(and__4593__auto__){
return (ctx["no-key"]);
} else {
return and__4593__auto__;
...
var G__6310 = (cljs.core.count.call(null,argv) - first_child);
switch (G__6310) {
case (0):
...
break;
default:
return (React["createElement"]).apply(null,cljs.core.reduce_kv.call(null,((function (G__6310){
