...
reagent.impl.template.NativeWrapper.cljs$lang$ctorPrWriter = (function (this__17373__auto__,writer__17374__auto__,opt__17375__auto__){
return cljs.core._write.call(null,writer__17374__auto__,"reagent.impl.template/NativeWrapper");
});
...
var or__16775__auto__ = reagent.impl.template.named_QMARK_.call(null,x);
...
var or__16775__auto__ = reagent.impl.template.hiccup_tag_QMARK_.call(null,x);
if(cljs.core.truth_(or__16775__auto__)){
return or__16775__auto__;
} else {
...
var G__25425 = o;
(G__25425[reagent.impl.template.cached_prop_name.call(null,k)] = reagent$impl$template$convert_prop_value.call(null,v));
...
while (G__25427__i < G__25427__a.length) {G__25427__a[G__25427__i] = arguments[G__25427__i + 0]; ++G__25427__i;}
  args = new cljs.core.IndexedSeq(G__25427__a,0);
} 
...
var old_25429 = (p["className"]);
(p["className"] = ((cljs.core.some_QMARK_.call(null,old_25429))?[cljs.core.str(class$),cljs.core.str(" "),cljs.core.str(old_25429)].join(''):class$));
} else {
}
...
if(cljs.core.not.call(null,(function (){var and__16763__auto__ = (node === document.activeElement);
if(and__16763__auto__){
var and__16763__auto____$1 = reagent.impl.template.has_selection_api_QMARK_.call(null,(node["type"]));
...
if(cljs.core.truth_((function (){var and__16763__auto__ = (jsprops["hasOwnProperty"])("onChange");
...
var G__25432 = jsprops;
(G__25432["defaultValue"] = value);

(G__25432["onChange"] = ((function (G__25432,v,value,on_change){
return (function (p1__25430_SHARP_){
return reagent.impl.template.input_handle_change.call(null,this$,on_change,p1__25430_SHARP_);
});})(G__25432,v,value,on_change))
);
...
var vec__25434 = cljs.core.next.call(null,cljs.core.re_matches.call(null,reagent.impl.template.re_tag,cljs.core.name.call(null,hiccup_tag)));
var tag = cljs.core.nth.call(null,vec__25434,(0),null);
var id = cljs.core.nth.call(null,vec__25434,(1),null);
var class$ = cljs.core.nth.call(null,vec__25434,(2),null);
...
var temp__4659__auto__ = (function (){var G__25438 = cljs.core.meta.call(null,v);
if((G__25438 == null)){
return null;
} else {
return reagent.impl.template.get_key.call(null,G__25438);
}
})();
if((temp__4659__auto__ == null)){
...
var jsprops = {"argv": v};
var G__25440_25441 = v;
var G__25440_25442__$1 = (((G__25440_25441 == null))?null:reagent.impl.template.key_from_vec.call(null,G__25440_25441));
if((G__25440_25442__$1 == null)){
} else {
(jsprops["key"] = G__25440_25442__$1);
}
...
var p = (function (){var temp__4659__auto__ = (function (){var G__25445 = cljs.core.meta.call(null,argv);
if((G__25445 == null)){
return null;
} else {
return reagent.impl.template.get_key.call(null,G__25445);
}
})();
if((temp__4659__auto__ == null)){
return jsprops;
...
var G__25446 = (((jsprops == null))?{}:jsprops);
(G__25446["key"] = key);
...
var G__25447 = new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subs.call(null,n,(0),pos),cljs.core.assoc.call(null,v,(0),cljs.core.subs.call(null,n,(pos + (1))))], null);
v = G__25447;
continue;
}
} else {
...
var n__17678__auto___25448 = a.length;
var i_25449 = (0);
while(true){
if((i_25449 < n__17678__auto___25448)){
(a[i_25449] = reagent.impl.template.as_element.call(null,(a[i_25449])));

var G__25450 = (i_25449 + (1));
i_25449 = G__25450;
continue;
} else {
}
...
var a = cljs.core.into_array.call(null,s);
var n__17678__auto___25451 = a.length;
var i_25452 = (0);
while(true){
if((i_25452 < n__17678__auto___25451)){
var val_25453 = (a[i_25452]);
if((cljs.core.vector_QMARK_.call(null,val_25453)) && ((reagent.impl.template.key_from_vec.call(null,val_25453) == null))){
(o["no-key"] = true);
} else {
}

(a[i_25452] = reagent.impl.template.as_element.call(null,val_25453));

var G__25454 = (i_25452 + (1));
i_25452 = G__25454;
continue;
} else {
}
...
if(cljs.core.truth_((function (){var and__16763__auto__ = cljs.core.not.call(null,reagent.impl.component._STAR_non_reactive_STAR_);
if(and__16763__auto__){
return (ctx["no-key"]);
} else {
return and__16763__auto__;
...
var G__25456 = (cljs.core.count.call(null,argv) - first_child);
switch (G__25456) {
case (0):
...
break;
default:
return (React["createElement"]).apply(null,cljs.core.reduce_kv.call(null,((function (G__25456){
