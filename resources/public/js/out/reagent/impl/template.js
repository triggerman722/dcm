...
reagent.impl.template.NativeWrapper.cljs$lang$ctorPrWriter = (function (this__5203__auto__,writer__5204__auto__,opt__5205__auto__){
return cljs.core._write(writer__5204__auto__,"reagent.impl.template/NativeWrapper");
});
...
var or__4605__auto__ = reagent.impl.template.named_QMARK_(x);
...
var or__4605__auto__ = reagent.impl.template.hiccup_tag_QMARK_(x);
if(cljs.core.truth_(or__4605__auto__)){
return or__4605__auto__;
} else {
...
var G__9024 = o;
(G__9024[reagent.impl.template.cached_prop_name(k)] = reagent$impl$template$convert_prop_value(v));
...
var old_9028 = (p["className"]);
(p["className"] = ((cljs.core.some_QMARK_(old_9028))?[cljs.core.str(class$),cljs.core.str(" "),cljs.core.str(old_9028)].join(''):class$));
} else {
}
...
if(cljs.core.not((function (){var and__4593__auto__ = (node === document.activeElement);
if(and__4593__auto__){
var and__4593__auto____$1 = reagent.impl.template.has_selection_api_QMARK_((node["type"]));
if(cljs.core.truth_(and__4593__auto____$1)){
...
if(cljs.core.truth_((function (){var and__4593__auto__ = (jsprops["hasOwnProperty"])("onChange");
...
var G__9031 = jsprops;
(G__9031["defaultValue"] = value);

(G__9031["onChange"] = ((function (G__9031,v,value,on_change){
return (function (p1__9029_SHARP_){
return reagent.impl.template.input_handle_change(this$,on_change,p1__9029_SHARP_);
});})(G__9031,v,value,on_change))
);
...
var vec__9033 = cljs.core.next(cljs.core.re_matches(reagent.impl.template.re_tag,cljs.core.name(hiccup_tag)));
var tag = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__9033,(0),null);
var id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__9033,(1),null);
var class$ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__9033,(2),null);
...
var temp__4659__auto__ = (function (){var G__9037 = cljs.core.meta(v);
if((G__9037 == null)){
return null;
} else {
return reagent.impl.template.get_key(G__9037);
}
})();
if((temp__4659__auto__ == null)){
...
var jsprops = {"argv": v};
var G__9039_9040 = v;
var G__9039_9041__$1 = (((G__9039_9040 == null))?null:reagent.impl.template.key_from_vec(G__9039_9040));
if((G__9039_9041__$1 == null)){
} else {
(jsprops["key"] = G__9039_9041__$1);
}
...
var G__9045 = cljs.core.with_meta(new cljs.core.PersistentVector(null, 5, 5, cljs.core.PersistentVector.EMPTY_NODE, [reagent.impl.template.reagent_input(),argv,comp,jsprops,first_child], null),cljs.core.meta(argv));
return (reagent.impl.template.as_element.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.template.as_element.cljs$core$IFn$_invoke$arity$1(G__9045) : reagent.impl.template.as_element.call(null,G__9045));
} else {
var p = (function (){var temp__4659__auto__ = (function (){var G__9046 = cljs.core.meta(argv);
if((G__9046 == null)){
return null;
} else {
return reagent.impl.template.get_key(G__9046);
}
})();
if((temp__4659__auto__ == null)){
return jsprops;
...
var G__9047 = (((jsprops == null))?{}:jsprops);
(G__9047["key"] = key);
...
var G__9048 = new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subs.cljs$core$IFn$_invoke$arity$3(n,(0),pos),cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(v,(0),cljs.core.subs.cljs$core$IFn$_invoke$arity$2(n,(pos + (1))))], null);
v = G__9048;
continue;
}
} else {
...
var n__5508__auto___9049 = a.length;
var i_9050 = (0);
while(true){
if((i_9050 < n__5508__auto___9049)){
(a[i_9050] = reagent.impl.template.as_element((a[i_9050])));
...
var a = cljs.core.into_array.cljs$core$IFn$_invoke$arity$1(s);
var n__5508__auto___9052 = a.length;
var i_9053 = (0);
while(true){
if((i_9053 < n__5508__auto___9052)){
var val_9054 = (a[i_9053]);
if((cljs.core.vector_QMARK_(val_9054)) && ((reagent.impl.template.key_from_vec(val_9054) == null))){
(o["no-key"] = true);
} else {
}

(a[i_9053] = reagent.impl.template.as_element(val_9054));

var G__9055 = (i_9053 + (1));
i_9053 = G__9055;
continue;
} else {
}
...
if(cljs.core.truth_((function (){var and__4593__auto__ = cljs.core.not(reagent.impl.component._STAR_non_reactive_STAR_);
if(and__4593__auto__){
return (ctx["no-key"]);
} else {
return and__4593__auto__;
...
var G__9057 = (cljs.core.count(argv) - first_child);
switch (G__9057) {
case (0):
...
break;
default:
return (React["createElement"]).apply(null,cljs.core.reduce_kv(((function (G__9057){
