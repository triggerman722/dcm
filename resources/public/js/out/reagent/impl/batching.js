...
var c_6268 = (a[i]);
if(cljs.core.truth_((c_6268["cljsIsDirty"]))){
(c_6268["forceUpdate"])();
} else {
}
...
return cljs.core._write.call(null,writer__5204__auto__,"reagent.impl.batching/RenderQueue");
});
...
var G__6272 = c;
var G__6272__$1 = (((G__6272 == null))?null:(G__6272["props"]));
if((G__6272__$1 == null)){
return null;
} else {
return (G__6272__$1["argv"]);
}
});
...
var G__6274_6275 = (c["cljsRatom"]);
if((G__6274_6275 == null)){
} else {
reagent.ratom.dispose_BANG_.call(null,G__6274_6275);
}
