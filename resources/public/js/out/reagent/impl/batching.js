...
var or__16775__auto__ = (w["requestAnimationFrame"]);
if(cljs.core.truth_(or__16775__auto__)){
return or__16775__auto__;
} else {
var or__16775__auto____$1 = (w["webkitRequestAnimationFrame"]);
if(cljs.core.truth_(or__16775__auto____$1)){
return or__16775__auto____$1;
} else {
var or__16775__auto____$2 = (w["mozRequestAnimationFrame"]);
if(cljs.core.truth_(or__16775__auto____$2)){
return or__16775__auto____$2;
} else {
var or__16775__auto____$3 = (w["msRequestAnimationFrame"]);
if(cljs.core.truth_(or__16775__auto____$3)){
return or__16775__auto____$3;
} else {
...
var n__17678__auto__ = a.length;
var i = (0);
while(true){
if((i < n__17678__auto__)){
var c_25414 = (a[i]);
if(cljs.core.truth_((c_25414["cljsIsDirty"]))){
(c_25414["forceUpdate"])();
} else {
}
...
reagent.impl.batching.RenderQueue.cljs$lang$ctorPrWriter = (function (this__17373__auto__,writer__17374__auto__,opt__17375__auto__){
return cljs.core._write.call(null,writer__17374__auto__,"reagent.impl.batching/RenderQueue");
});
...
var G__25418 = c;
var G__25418__$1 = (((G__25418 == null))?null:(G__25418["props"]));
if((G__25418__$1 == null)){
return null;
} else {
return (G__25418__$1["argv"]);
}
});
...
var G__25420_25421 = (c["cljsRatom"]);
if((G__25420_25421 == null)){
} else {
reagent.ratom.dispose_BANG_.call(null,G__25420_25421);
}
