...
var count_31147 = (0);
while(true){
var m_31148 = cljs.core.async.impl.dispatch.tasks.pop();
if((m_31148 == null)){
} else {
m_31148.call(null);

if((count_31147 < cljs.core.async.impl.dispatch.TASK_BATCH_SIZE)){
var G__31149 = (count_31147 + (1));
count_31147 = G__31149;
continue;
} else {
}
}
